...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void checkCollision() {
        ...
        if (ball.intersects(paddle1)) {
            ...
            // ball.xVelocity++; // optional for more difficulty speeding the ball
            // if (ball.yVelocity > 0) {
            //     ball.yVelocity++; // optional speeds up the ball for difficulty
            // } else {
            //     ball.yVelocity--;
            // }
    ...
    // this will be for later use to add a background for the rectangle
